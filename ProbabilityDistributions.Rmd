...
## b) No person with diabetes
dbinom(0, size = 50, prob = 0.09)
## b) Exactly one person with diabetes
dbinom(1, size = 50, prob = 0.09)
```


```{r}
## b) At least two persons with diabetes: 1-P(X<=1)
1 - pbinom(1, size = 50, prob = 0.09)
```


```{r}
## b) At least two persons with diabetes: P(X > 1)
...
```{r}
## b) at least one person with diabetes
...
```{r}
## probability of 0, 1, 2, 3 defective bulbs
## with replacement
...
```{r}
## a) 20th bulb = 1st defective bulb
dnbinom(19, size = 1, prob = 0.01)
## b) At most 250 persons to get 20 patients with diabetes
...
```{r}
## a) at least one defective bulb
ppois(0, lambda = 1.4, lower.tail = FALSE)
## b) at least 450 new cases
...
curve(expr = dnorm(x, mean = 167, sd = 6.0), from = 140, to = 210, n = 501,
      col = "#E41A1C", xlab = "Body height in cm", ylab = "Density",
      main = "Body height of German men and women")
curve(expr = dnorm(x, mean = 180, sd = 6.5), from = 140, to = 210, n = 501,
      add = TRUE, col = "#377EB8")
legend("topleft", legend = c("women", "men"), fill = c("#E41A1C", "#377EB8"))
```
...
curve(dgamma(x, scale = 5, shape = 1.8), from = 0, to = 30, n = 501,
      xlab = "Hospital length of stay in days", ylab = "Density",
      main = "A selected DRG")
```
...
curve(dweibull(x, scale = 1/0.34657, shape = 2.12), from = 0, to = 30, n = 501,
      xlab = "Life expectancy in years", ylab = "Density",
      main = "Life expectancy of a smart phone battery including aging")
```
